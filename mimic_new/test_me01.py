...
class KnowledgeAttention(keras.layers.Layer):
    def __init__(self, output_dim, **kwargs):
        # inputs.shape = (batch_size, time_steps, seq_len)
        self.output_dim = output_dim
        super(KnowledgeAttention, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        ...
        super(KnowledgeAttention, self).build(input_shape)  # 一定要在最后调用它
...
if __name__ == '__main__':
    ...
    context_vector, weights = KnowledgeAttention(output_dim=128)([mask1, gru_out])
