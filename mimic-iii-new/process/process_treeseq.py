...
if __name__ == '__main__':
    ...
    outFile2 = '../resource/mimic3_newTree'

    data_seqs = pickle.load(open('../resource/mimic3.seqs', 'rb'))
    trees_type = pickle.load(open('../resource/mimic3.types', 'rb'))
    ...
    for i in range(4880, len(retype)):
