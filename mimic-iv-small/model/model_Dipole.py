...
class metricsHistory(Callback):
    def __init__(self):
        ...
        self.Recall_5 = []
        self.Precision_5 = []
        self.path = 'G:\\mimic4_model_save\\model_Dipole\\Dipole_' + str(gru_dimentions)
        # self.path = 'G:\\mimic4_model_save\\model_Dipole\\Dipole_' + str(gru_dimentions) + '_dropout02'
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        if self.bestRecall < recall5:
            ...
            tf.keras.models.save_model(model, self.path+'\\Dipole_epoch_' + str((epoch+1)))
