...
def padMatrix(seqs, labels, treeseqs):
    ...
    inputDimSize = calculate_dimSize('../resource/mimic4.seqs')
...
#         self.Recall_5 = []
#         self.Precision_5 = []
#         self.path = 'G:\\模型训练保存\\Dipole_' + str(gru_dimentions) + '_dropout\\rate05\\'
...
if __name__ == '__main__':
    ...
    labelFile = '../resource/process_data/mimic4_ccs.labelseqs'
    treeFile = '../resource/process_data/mimic4.treeseqs'
    ...
    #     filepath='G:\\模型训练保存\\Dipole_'+str(gru_dimentions)+'_dropout\\rate05\\model_{epoch:02d}', save_freq='epoch')
    #
