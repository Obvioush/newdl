...
class metricsHistory(Callback):
    def __init__(self):
        ...
        self.Recall_5 = []
        self.Precision_5 = []
        self.path = 'G:\\mimic3_model_save\\model_NKAM_gamma\\NKAM_new_' + str(gru_dimentions)
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        if self.bestRecall < recall5:
            ...
            tf.keras.models.save_model(model, self.path+'\\NKAM_gamma_epoch_' + str((epoch+1)))
...
if __name__ == '__main__':
    ...
    emb = keras.layers.Dense(128, activation='relu', name='diagcode_emb', trainable=False)(mask)
    ...
    tree_emb = keras.layers.Dense(128, activation='relu', name='knowledge_emb', trainable=False)(tree_mask)


    st = keras.layers.concatenate([gru_out, tree_emb], axis=-1)
