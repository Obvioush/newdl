...
if __name__ == '__main__':
    ...
    temp = {}  # temp的key为icd9转化后的编码(0-8258), value为ccs的分类编码
    category = []
    ...
    ccsMap = {}  # MIMIC4的数据中一共有283个唯一ccs分类编码, key:ccs分类编码, value:0-282
    for i in range(len(category)):
        ccsMap[category[i]] = i

    indexMap = {}  # key:icd9的index(0-8258), value: ccs唯一分组(0-282)
