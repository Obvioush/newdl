...
if __name__ == '__main__':
    ...
    # glovePatientFile = '../resource/gram_emb/mimic3_glove_patient_emb.npy'
    ...
    emb = keras.layers.Dense(128, activation='relu', name='emb')(mask)
    ...
    tree_emb = keras.layers.Dense(128, trainable=True, name='tree_emb')(tree_mask)
    ...
    checkpoint = tf.keras.callbacks.ModelCheckpoint(
        filepath='G:\\mimic3_model_save\\model_GCSAM\\emb_no\\NEW_epoch_{epoch:02d}',
        monitor='val_loss',
        save_best_only=True,
        mode='auto')
