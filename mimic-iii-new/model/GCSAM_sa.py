...
if __name__ == '__main__':
    ...
    head1, weights1 = ScaledDotProductAttention(output_dim=128)([tree_emb, rnn])
    head2, weights2 = ScaledDotProductAttention(output_dim=128)([tree_emb, rnn])
    ...
    checkpoint = tf.keras.callbacks.ModelCheckpoint(
        filepath='G:\\mimic3_model_save\\model_GCSAM\\test_sa\\NEW_epoch_{epoch:02d}',
        monitor='val_loss',
        save_best_only=True,
        mode='auto')
