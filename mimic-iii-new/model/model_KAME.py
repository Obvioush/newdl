...
class metricsHistory(Callback):
    def __init__(self):
        ...
        self.Recall_5 = []
        self.Precision_5 = []
        self.path = 'G:\\mimic3_model_save\\model_KAME\\KAME_' + str(gru_dimentions)
        # self.path = 'G:\\mimic3_model_save\\model_KAME\\KAME_' + str(gru_dimentions) + '_dropout02'
...
if __name__ == '__main__':
    ...
    gloveKnowledgeFile = '../resource/gram_emb/mimic3_glove_knowledge_emb.npy'
    ...
    x = np.matmul(x, tf.expand_dims(gram_emb, 0))
    x_valid = np.matmul(x_valid, tf.expand_dims(gram_emb, 0))
    x_test = np.matmul(x_test, tf.expand_dims(gram_emb, 0))
