...
class metricsHistory(Callback):
    def __init__(self):
        ...
        self.Recall_5 = []
        self.Precision_5 = []
        self.path = 'G:\\mimic3_model_save\\model_GRAM\\GRAM_' + str(gru_dimentions)
        # self.path = 'G:\\mimic3_model_save\\model_GRAM\\GRAM_' + str(gru_dimentions) + '_dropout02'
...
if __name__ == '__main__':
    ...
    gram_params = np.load('../resource/gram_emb/mimic3_gram.33.npz')
    ...
    for i in range(5, 1, -1):
        leaves, ancestors = build_tree('../resource/mimic3.level' + str(i) + '.pk')
    ...
    emb = np.array(tf.concat(embList, axis=0))
