...
class BahdanauAttention(keras.Model):
    ...
    def call(self, knowledge_onehot, encoder_outputs):
        ...
        score = self.V(tf.nn.tanh(
            self.W1(encoder_outputs) + self.W2(knowledge_onehot)))
...
if __name__ == '__main__':
    ...
    # tree1 = generate_latentMatrix(tree_valid)
    ...
    Knowledgeattention = BahdanauAttention(units=128)
    context_vector, attention_weights = Knowledgeattention(mask1, gru_out)
