...
class metricsHistory(Callback):
    def __init__(self):
        ...
        self.Recall_5 = []
        self.Precision_5 = []
        self.path = 'G:\\mimic4_model_save\\model_RNN\\RNN_' + str(gru_dimentions)
        # self.path = 'G:\\mimic4_model_save\\model_RNN\\RNN_' + str(gru_dimentions) + '_dropout02'
...
if __name__ == '__main__':
    ...
    checkpoint = tf.keras.callbacks.ModelCheckpoint(
                    filepath='G:\\mimic4_model_save\\model_RNN\\RNN_' + str(gru_dimentions) + '\\RNN_epoch_{epoch:02d}',
                    monitor='val_loss',
                    save_best_only=True,
                    mode='auto')
