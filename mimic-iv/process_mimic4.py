...
# python process_mimic4.py admissions.csv diagnoses_icd.csv <output file>
...
if __name__ == '__main__':
    admissionFile = '/Users/masaka/Documents/MIMIC-IV数据集/admissions.csv'
    diagnosisFile = '/Users/masaka/Documents/MIMIC-IV数据集/diagnoses_icd.csv'
    # outFile = sys.argv[3]
    ...
    for line in infd:
        ...
        if int(tokens[4]) == 9:
            pid = int(tokens[0])
            admId = int(tokens[1])
            dxStr = 'D_' + convert_to_icd9(tokens[
                                               3])  ############## Uncomment this line and comment the line below, if you want to use the entire ICD9 digits.
