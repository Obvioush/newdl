...
if __name__ == '__main__':
    ...
    node2vec_emb = np.load('../resource/node2vec_emb/patient_emb.npy')
    ...
    emb = keras.layers.Dense(128, kernel_initializer=keras.initializers.constant(node2vec_emb), name='emb')(mask)
