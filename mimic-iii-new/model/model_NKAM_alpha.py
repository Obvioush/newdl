...
class metricsHistory(Callback):
    def __init__(self):
        ...
        self.Recall_5 = []
        self.Precision_5 = []
        self.path = 'G:\\mimic3_model_save\\model_NKAM_alpha\\NKAM_' + str(gru_dimentions)
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        if self.bestRecall < recall5:
            ...
            tf.keras.models.save_model(model, self.path+'\\NKAM_alpha_epoch_' + str((epoch+1)))
...
if __name__ == '__main__':
    ...
    emb = keras.layers.Dense(128, activation='relu', name='diagcode_emb')(mask)
    ...
    tree_emb = keras.layers.Dense(128, activation='relu', name='knowledge_emb')(tree_mask)
